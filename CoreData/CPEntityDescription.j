...
+ (CPEntityDescription) entityForName: (CPString) entityName inManagedObjectContext: (CPManagedObjectContext) ctxt
{
  	var aModel = [[ctxt storeCoordinator] managedObjectModel];

	return [aModel  entityWithName: entityName];
}
